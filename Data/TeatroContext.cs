    ...
    : base(options)
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Actores>().HasData(
                new Actores { ActorId = 1, Nombre = "Palmira Cardo" },
                new Actores { ActorId = 2, Nombre = "Aarón Doménech" },
                new Actores { ActorId = 3, Nombre = "Daniela Fernanda" },
                new Actores { ActorId = 4, Nombre = "María Gayubo" },
                new Actores { ActorId = 5, Nombre = "Nuria Luna" },
                new Actores { ActorId = 6, Nombre = "Marc Orero" },
                new Actores { ActorId = 7, Nombre = "Pako Portalo" },
                new Actores { ActorId = 8, Nombre = "María Sabaté" },
                new Actores { ActorId = 9, Nombre = "Josie Sinnadurai" },
                new Actores { ActorId = 10, Nombre = "Fernando Tejero" },
                new Actores { ActorId = 11, Nombre = "Dani Muriel" },
                new Actores { ActorId = 12, Nombre = "Mabel del Pozo" },
                new Actores { ActorId = 13, Nombre = "Belén Rueda" },
                new Actores { ActorId = 14, Nombre = "Luisa Martín" },
                new Actores { ActorId = 15, Nombre = "Juan Fernández" },
                new Actores { ActorId = 16, Nombre = "Pablo Puyol" },
                new Actores { ActorId = 17, Nombre = "Sergio Mur" },
                new Actores { ActorId = 18, Nombre = "Antonio Sansano" },
                new Actores { ActorId = 19, Nombre = "Jorge Mayor" },
                new Actores { ActorId = 20, Nombre = "José Fernández" },
                new Actores { ActorId = 21, Nombre = "José de la Torre" },
                new Actores { ActorId = 22, Nombre = "Christian Escuredo" },
                new Actores { ActorId = 23, Nombre = "Dídac Flores" },
                new Actores { ActorId = 24, Nombre = "Carmen Raigón" },
                new Actores { ActorId = 25, Nombre = "Marta Valverde" },
                new Actores { ActorId = 26, Nombre = "Chema Noci" },
                new Actores { ActorId = 27, Nombre = "Fernando Cayo" },
                new Actores { ActorId = 28, Nombre = "Belén Orihuela" },
                new Actores { ActorId = 29, Nombre = "Julián Salguero" },
                new Actores { ActorId = 30, Nombre = "Paris Martín" },
                new Actores { ActorId = 31, Nombre = "Linda Estefanía Rocamora" },
                new Actores { ActorId = 32, Nombre = "Javier del Arco" },
                new Actores { ActorId = 33, Nombre = "Ángela Rucas" },
                new Actores { ActorId = 34, Nombre = "Carmela Martins" },
                new Actores { ActorId = 35, Nombre = "Raúl Heredia" },
                new Actores { ActorId = 36, Nombre = "Nicolás Ojeda" },
                new Actores { ActorId = 37, Nombre = "Asier Meléndez" },
                new Actores { ActorId = 38, Nombre = "Nayeli Robert" },
                new Actores { ActorId = 39, Nombre = "David García" },
                new Actores { ActorId = 40, Nombre = "Samuel J. Nikana" },
                new Actores { ActorId = 41, Nombre = "Leonardo Rabat Buila" },
                new Actores { ActorId = 42, Nombre = "Yihao Luis Wu" },
                new Actores { ActorId = 43, Nombre = "José David Kasparett Salcedo" },
                new Actores { ActorId = 44, Nombre = "José Carlos Jiménez Carranza" },
                new Actores { ActorId = 45, Nombre = "Silvestre Okuru" },
                new Actores { ActorId = 46, Nombre = "Nguema Angue Somo" },
                new Actores { ActorId = 47, Nombre = "Yichen Alex Wu" },
                new Actores { ActorId = 48, Nombre = "Pablo Pérez Clergas" },
                new Actores { ActorId = 49, Nombre = "Valentina Carrascón" },
                new Actores { ActorId = 50, Nombre = "Minerva Carrascón" },
                new Actores { ActorId = 51, Nombre = "Josema Yuste" },
                new Actores { ActorId = 52, Nombre = "Javier Losán" },
                new Actores { ActorId = 53, Nombre = "Santiago Urrialde" },
                new Actores { ActorId = 54, Nombre = "Esther del Prado" },
                new Actores { ActorId = 55, Nombre = "María Sánchez" },
                new Actores { ActorId = 56, Nombre = "Javier Posadas" },
                new Actores { ActorId = 57, Nombre = "Adrián Martín" },
                new Actores { ActorId = 58, Nombre = "Víctor Linuesa" },
                new Actores { ActorId = 59, Nombre = "Alejandro de la Fuente" }
                );
            modelBuilder.Entity<Funciones>().HasData(
                new Funciones { FunciónID = 1, ObraID = 1, SalaID = 3, Fecha = new DateTime(2023, 12, 11), Hora = "20:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 2, ObraID = 1, SalaID = 4, Fecha = new DateTime(2023, 12, 11), Hora = "18:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 3, ObraID = 1, SalaID = 6, Fecha = new DateTime(2023, 12, 11), Hora = "16:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 4, ObraID = 1, SalaID = 2, Fecha = new DateTime(2023, 12, 12), Hora = "20:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 5, ObraID = 1, SalaID = 6, Fecha = new DateTime(2023, 12, 13), Hora = "20:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 6, ObraID = 1, SalaID = 5, Fecha = new DateTime(2023, 12, 14), Hora = "18:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 7, ObraID = 1, SalaID = 2, Fecha = new DateTime(2023, 12, 15), Hora = "16:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 8, ObraID = 1, SalaID = 5, Fecha = new DateTime(2023, 12, 15), Hora = "18:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 9, ObraID = 2, SalaID = 6, Fecha = new DateTime(2023, 12, 15), Hora = "20:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 10, ObraID = 2, SalaID = 2, Fecha = new DateTime(2023, 12, 15), Hora = "18:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 11, ObraID = 2, SalaID = 3, Fecha = new DateTime(2023, 12, 16), Hora = "16:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 12, ObraID = 2, SalaID = 1, Fecha = new DateTime(2023, 12, 16), Hora = "20:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 13, ObraID = 2, SalaID = 2, Fecha = new DateTime(2023, 12, 17), Hora = "20:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 14, ObraID = 2, SalaID = 1, Fecha = new DateTime(2023, 12, 17), Hora = "18:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 15, ObraID = 3, SalaID = 1, Fecha = new DateTime(2023, 12, 13), Hora = "20:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 16, ObraID = 3, SalaID = 3, Fecha = new DateTime(2023, 12, 15), Hora = "18:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 17, ObraID = 3, SalaID = 2, Fecha = new DateTime(2023, 12, 17), Hora = "16:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 18, ObraID = 4, SalaID = 4, Fecha = new DateTime(2023, 12, 13), Hora = "20:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 19, ObraID = 4, SalaID = 6, Fecha = new DateTime(2023, 12, 15), Hora = "18:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 20, ObraID = 4, SalaID = 5, Fecha = new DateTime(2023, 12, 17), Hora = "16:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 21, ObraID = 5, SalaID = 2, Fecha = new DateTime(2023, 12, 11), Hora = "20:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 22, ObraID = 5, SalaID = 1, Fecha = new DateTime(2023, 12, 13), Hora = "18:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 23, ObraID = 5, SalaID = 5, Fecha = new DateTime(2023, 12, 15), Hora = "16:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 24, ObraID = 6, SalaID = 2, Fecha = new DateTime(2023, 12, 15), Hora = "20:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 25, ObraID = 6, SalaID = 4, Fecha = new DateTime(2023, 12, 16), Hora = "18:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 26, ObraID = 6, SalaID = 3, Fecha = new DateTime(2023, 12, 17), Hora = "16:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 27, ObraID = 6, SalaID = 6, Fecha = new DateTime(2023, 12, 18), Hora = "10:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 28, ObraID = 6, SalaID = 4, Fecha = new DateTime(2023, 12, 19), Hora = "11:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 29, ObraID = 6, SalaID = 2, Fecha = new DateTime(2023, 12, 20), Hora = "16:00", Desponibilidad = "Si" },
                new Funciones { FunciónID = 30, ObraID = 7, SalaID = 5, Fecha = new DateTime(2023, 12, 15), Hora = "20:00", Desponibilidad = "Si" }
