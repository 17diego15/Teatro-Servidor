    ...
    : base(options)
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Funcion>().HasData(
                new Funcion { FuncionID = 1, ObraID = 1, SalaID = 3, Fecha = new DateTime(2023, 12, 11), Hora = "20:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 2, ObraID = 1, SalaID = 4, Fecha = new DateTime(2023, 12, 11), Hora = "18:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 3, ObraID = 1, SalaID = 6, Fecha = new DateTime(2023, 12, 11), Hora = "16:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 4, ObraID = 1, SalaID = 2, Fecha = new DateTime(2023, 12, 12), Hora = "20:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 5, ObraID = 1, SalaID = 6, Fecha = new DateTime(2023, 12, 13), Hora = "20:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 6, ObraID = 1, SalaID = 5, Fecha = new DateTime(2023, 12, 14), Hora = "18:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 7, ObraID = 1, SalaID = 2, Fecha = new DateTime(2023, 12, 15), Hora = "16:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 8, ObraID = 1, SalaID = 5, Fecha = new DateTime(2023, 12, 15), Hora = "18:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 9, ObraID = 2, SalaID = 6, Fecha = new DateTime(2023, 12, 15), Hora = "20:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 10, ObraID = 2, SalaID = 2, Fecha = new DateTime(2023, 12, 15), Hora = "18:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 11, ObraID = 2, SalaID = 3, Fecha = new DateTime(2023, 12, 16), Hora = "16:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 12, ObraID = 2, SalaID = 1, Fecha = new DateTime(2023, 12, 16), Hora = "20:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 13, ObraID = 2, SalaID = 2, Fecha = new DateTime(2023, 12, 17), Hora = "20:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 14, ObraID = 2, SalaID = 1, Fecha = new DateTime(2023, 12, 17), Hora = "18:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 15, ObraID = 3, SalaID = 1, Fecha = new DateTime(2023, 12, 13), Hora = "20:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 16, ObraID = 3, SalaID = 3, Fecha = new DateTime(2023, 12, 15), Hora = "18:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 17, ObraID = 3, SalaID = 2, Fecha = new DateTime(2023, 12, 17), Hora = "16:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 18, ObraID = 4, SalaID = 4, Fecha = new DateTime(2023, 12, 13), Hora = "20:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 19, ObraID = 4, SalaID = 6, Fecha = new DateTime(2023, 12, 15), Hora = "18:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 20, ObraID = 4, SalaID = 5, Fecha = new DateTime(2023, 12, 17), Hora = "16:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 21, ObraID = 5, SalaID = 2, Fecha = new DateTime(2023, 12, 11), Hora = "20:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 22, ObraID = 5, SalaID = 1, Fecha = new DateTime(2023, 12, 13), Hora = "18:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 23, ObraID = 5, SalaID = 5, Fecha = new DateTime(2023, 12, 15), Hora = "16:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 24, ObraID = 6, SalaID = 2, Fecha = new DateTime(2023, 12, 15), Hora = "20:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 25, ObraID = 6, SalaID = 4, Fecha = new DateTime(2023, 12, 16), Hora = "18:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 26, ObraID = 6, SalaID = 3, Fecha = new DateTime(2023, 12, 17), Hora = "16:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 27, ObraID = 6, SalaID = 6, Fecha = new DateTime(2023, 12, 18), Hora = "10:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 28, ObraID = 6, SalaID = 4, Fecha = new DateTime(2023, 12, 19), Hora = "11:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 29, ObraID = 6, SalaID = 2, Fecha = new DateTime(2023, 12, 20), Hora = "16:00", Desponibilidad = "Si" },
                new Funcion { FuncionID = 30, ObraID = 7, SalaID = 5, Fecha = new DateTime(2023, 12, 15), Hora = "20:00", Desponibilidad = "Si" }
